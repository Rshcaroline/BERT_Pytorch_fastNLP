...
from utils import whitespace_tokenize, BasicTokenizer, BertTokenizer
from utils import VOCAB_NAME, MODEL_NAME, BERT_CONFIG
from optimization import BertAdam

from preprocess.question_answering import load_dataset
...
def main():
    ...
    parser.add_argument("--output_dir", default='tasks/QuestionAnswering/squad_output', type=str, required=False,
                        help="The output directory where the model checkpoints and predictions will be written.")

    ## Other parameters
    parser.add_argument("--train_file", default='tasks/QuestionAnswering/squad_data/train-v1.1.json', type=str, help="SQuAD json for training. E.g., train-v1.1.json")
    parser.add_argument("--predict_file", default='tasks/QuestionAnswering/squad_data/dev-v1.1.json', type=str,
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                logits = model(x=input_ids, segment_info=segment_ids, mask=input_mask)
                ...
                loss = (criterion(logits_start, start_positions) + criterion(logtis_end, end_positions)) / 2
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        eval_dataloader = DataLoader(dev_data, sampler=eval_sampler, batch_size=args.predict_batch_size)
